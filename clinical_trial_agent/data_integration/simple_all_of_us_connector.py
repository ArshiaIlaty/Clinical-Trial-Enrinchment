"""
Simplified All of Us Dataset Connector (No LangChain Dependencies)

This module provides a simplified data connector for the All of Us Registered Tier Dataset v8,
without dependencies on langchain, for testing core adherence labeling functionality.
...
class SimpleAllOfUsConnector:
    """
    Simplified connector for All of Us Registered Tier Dataset v8.
    ...
    def _apply_filters(
        ...
        # Filter by date range (skip for person domain since it's demographic data)
        if domain != 'person' and (start_date is not None or end_date is not None):
